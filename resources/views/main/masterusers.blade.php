        ...
        <div class="card">
            <div class="float-right">
                <div class="input-group">
                    ...
                    <a href="{{ route('formmasterusers') }}" class="btn btn-success rounded" id="buttonadd"><i class="fa-solid fa-plus mt-1"></i></a>  
                </div>
            </div>        
                ...
                <table class="table table-hover table responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>test</td>
                            <td>test</td>
                            <td style="max-width: 30px;"><a href="{{ route('formeditmasteruser') }}" class="btn btn-warning text-white " id="edit"><i class="fa-solid fa-pen-to-square" id="smallpen"></i></a></td>
                            <td style="max-width: 30px;"><a class="btn btn-danger text-white " id="delete"><i class="fa-solid fa-trash-can" id="smalltrash"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
