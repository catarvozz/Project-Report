        ...
        <div class="card">
            <div class="float-right">
                <div class="input-group">
                    ...
                    <a href="{{ route('formmasterpecahanuangs') }}" class="btn btn-success mr-3 rounded"><i class="fa-solid fa-plus mt-1"></i></a>  
                </div>
            </div>
                ...
                <table class="table table-hover table responsive">
                    ...
                    <tbody>
                        <tr>
                            <td>test</td>
                            <td>test</td>
                            <td style="max-width: 30px;"><a href="{{ route('formeditmasteruang') }}" class="btn btn-warning text-white" id="edit"><i class="fa-solid fa-pen-to-square" id="smallpen"></i></a></td>
